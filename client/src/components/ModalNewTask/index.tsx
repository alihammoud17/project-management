...
const ModalNewTask = ({ isOpen, onClose, id }: Props) => {
    ...
    const selectStyles = "mb-4 w-full rounded border-gray-300 px-3 py-2 dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none"
